"""IFC SE D=20, 3BA pool (Random, HillClimbing, CMAES). Scalability point D=3->10->20.
Mirrors scripts/configs/dt/ifc_d10.py with dim=20."""
...
root_dir = None
data_dir = './data/generated_data/ifc_d20'
cache_dir = './cache/ifc_d20/'
