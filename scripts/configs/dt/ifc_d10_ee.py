"""IFC EE (energy efficiency, Lee 2025 eq.32) D=10, 3BA pool (Random, HillClimbing, CMAES).
Mirrors scripts/configs/dt/ifc_d10.py (D=10 SE 3BA) with reward=EE for SE-vs-EE comparison."""
...
root_dir = None
data_dir = './data/generated_data/ifc_d10_ee'
cache_dir = './cache/ifc_d10_ee/'
