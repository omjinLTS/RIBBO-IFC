"""5BA-filter D=10 IFC SE: HC + RegEvol + Eagle + CMAES + BotorchBO.
Random + ShuffledGridSearch excluded per Song 2024 BC Filter pattern."""
...
root_dir = None
data_dir = './data/generated_data/ifc_d10_5bafilter'
cache_dir = './cache/ifc_d10_5bafilter/'
