"""IFC EE D=10, 4BA-filter pool (HillClimbing, RegularizedEvolution, EagleStrategy,
CMAES, CMAES) — BotorchBO dropped — Random/ShuffledGridSearch excluded. EE × curated pool."""
...
root_dir = None
data_dir = './data/generated_data/ifc_d10_ee_4bafilter'
cache_dir = './cache/ifc_d10_ee_4bafilter/'
